...
Task.create(name: "Decide on a venue", category_id: 3, start_time: DateTime.new(2017,9,25), description: "Start researching the best damn location for my wedding", task_budget: 9000)
