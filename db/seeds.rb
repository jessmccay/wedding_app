...
Task.create(name: "Order tables and chairs", category_id: 3, start_time: DateTime.new(2018,10,25), description: "Call eastgate rentals once the RSVPS are returned", task_budget: 150)
Task.create(name: "Order tent and dance floor", category_id: 3, start_time: DateTime.new(2018,10,25), description: "Call eastgate rentals once the RSVPS are returned", task_budget: 400)
Task.create(name: "Decide on a venue", category_id: 3, start_time: DateTime.new(2017,8,01), description: "Start researching the best damn location for my wedding", task_budget: 9000)
Task.create(name: "Go to a cake tasting", category_id: 4, start_time: DateTime.new(2017,2,25), description: "Eat loads and loads of cake", task_budget: 4000)
Task.create(name: "Engagement photos", category_id: 5, start_time: DateTime.new(2017,7,15), description: "Call and book photographer, decide on location", task_budget: 150)
Task.create(name: "Save the Date/'s", category_id: 5, start_time: DateTime.new(2017,8,01), description: "Be sure to obtain all addresses of potential guests", task_budget: 50)
Task.create(name: "Send invitations", category_id: 5, start_time: DateTime.new(2017,9,15), description: "Decide on DIY or premade", task_budget: 100)
...
Task.create(name: "Find a DJ", category_id: 6, start_time: DateTime.new(2018,3,25), description: "SFind a cool DJ for my wedding tunes", task_budget: 4000)
Task.create(name: "Message instagram artist for dress", category_id: 7, start_time: DateTime.new(2017,3,25), description: "None", task_budget: 4000)
Task.create(name: "Start making origami cranes", category_id: 8, start_time: DateTime.new(2017,6,25), description: "none", task_budget: 4000)
Task.create(name: "Order flowers", category_id: 8, start_time: DateTime.new(2017,6,25), description: "Farmers market or florist? Contact to compare rates", task_budget: 200)
Task.create(name: "Find a priest", category_id: 9, start_time: DateTime.new(2018,1,25), description: "Alex can get ordained online wooo", task_budget: 80)
Task.create(name: "Buy wedding bands", category_id: 10, start_time: DateTime.new(2015,5,25), description: "None", task_budget: 4000)
Task.create(name: "Book honeymoon suite in Bali", category_id: 11, start_time: DateTime.new(2018,1,25), description: "None", task_budget: 4000)
